# Ainsley Pyle
# I utilized my class notes to assist on the homework. 
...
def group_by_length(strings):
    ...
    string_lengths={}
    for word in strings:
        if len(word) not in string_lengths.keys():
            string_lengths[len(word)]=[word]
        else:
            string_lengths[len(word)].append(word)
